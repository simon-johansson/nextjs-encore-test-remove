// Code generated by the Encore v1.36.4 client generator. DO NOT EDIT.
...
export function Environment(name: string): BaseURL {
    return `https://${name}-nextjs-test-remove-wqbi.encr.app`
}
...
/**
 * Client is an API client for the nextjs-test-remove-wqbi Encore application. 
 */
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "nextjs-test-remove-wqbi-Generated-TS-Client (Encore/v1.36.4)";
        }
